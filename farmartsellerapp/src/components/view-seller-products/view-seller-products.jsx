import './view-seller-products.css';
...
export const ViewSellerProducts = () => {
    ...
    useEffect(() => { 
        if(user.SellerId){
            getSellerProductDetails(user.SellerId);    
        } 
    }, [user.SellerId]);
    ...
    return(
        ...
        <div className='main-post-products'>
            <h3 className="heading text-center pt-4 pb-2">My Posted Products</h3>
